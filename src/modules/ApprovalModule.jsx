...
export const POST_AWAY_DOC = 'approval/POST_AWAY_DOC';
...
export const POST_SAVE_AWAY = 'approval/POST_SAVE_AWAY';
...
export const GET_SW_DETAILS_FIN = 'approval/GET_SW_DETAILS_FIN';
export const GET_WFH_DETAILS_FIN = 'approval/GET_WFH_DETAILS_FIN';
...
const actions = createActions({
    ...
    [POST_SAVE_AWAY]: (payload) => payload,
    [GET_OUTBOX_SAVED]: (payload) => payload,
    [GET_OVERWORK_DETAILS_FIN]: (payload) => payload,
    [GET_SW_DETAILS_FIN]: (payload) => payload,
    [GET_WFH_DETAILS_FIN]: (payload) => payload,
...
const approvalReducer = handleActions(
    {
        ...
        [POST_AWAY_DOC]: (state, { payload }) => {
            console.log('POST_AWAY_DOC action dispatched. Payload:', payload);
            return payload;
        },
        ...
        [POST_SAVE_AWAY]: (state, { payload }) => {
            console.log('POST_SAVE_AWAY action dispatched. Payload:', payload);
            return payload;
        },
        ...
        [GET_SW_DETAILS_FIN]: (state, { payload }) => {
            console.log('GET_SW_DETAILS_FIN action dispatched. Payload:', payload);
            return payload ? payload : state;
        },
        [GET_WFH_DETAILS_FIN]: (state, { payload }) => {
            console.log('GET_WFH_DETAILS_FIN action dispatched. Payload:', payload);
            return payload ? payload : state;
        },
