...
import { callSubmitAwayAPI, callSaveAwayAPI } from '../../../apis/ApprovalAPICalls';
...
function WritingAway(){
    ...
    const onClickSaveHandler = () => {
        ...
        if (confirmed) {
            ...
            formData.append("workTypeTitle", form.workTypeTitle);
            formData.append("workTypeStartDate", form.workTypeStartDate);
            formData.append("workTypePlace", form.workTypePlace);
            formData.append("workTypeReason", form.workTypeReason);

            dispatch(callSaveAwayAPI({
                form: formData
            }));
    ...
    const onClickSubmitHandler = () => {
        ...
        if (confirmed) {
            ...
            // 문서 내용이 있는지 확인
            if (!form.workTypeTitle || !form.workTypeStartDate || !form.workTypePlace || !form.workTypeReason) {
                alert("문서 내용을 작성해주세요.");
                return; 
            }
            ...
            <div className="form_body">
                ...
                <div style={{ display: 'table-row' }}>
                        ...
                        <div className ="B" style={{ display: 'table-cell' }}>
                            <input className="input_box" type="text" name="workTypeTitle" value={form.workTypeTitle} onChange={onChangeHandler}/>
                        </div>
                    </div>
                    ...
                    <div style={{ display: 'table-row' }}>
                        ...
                        <div className ="B" style={{ display: 'table-cell' }}>
                            <input type="date" id="ov_working_date"  className="inputbox" name="workTypeStartDate" value={form.workTypeStartDate} onChange={onChangeHandler}/>
                        </div>
                    </div>
                    ...
                    <div style={{ display: 'table-row' }}>
                        ...
                        <div className ="B" style={{ display: 'table-cell' }}>
                            <input className="input_box" type="text" name="workTypeReason" value={form.workTypePlace} onChange={onChangeHandler}/>
                        </div>
                    </div>
                    ...
                    <div style={{ display: 'table-row' }}>
                        ...
                        <div className ="B" style={{ display: 'table-cell' }}>
                            <input className="input_box" type="text" name="workTypeReason" value={form.workTypeReason} onChange={onChangeHandler}/>
                        </div>
                    </div>
                </div>
            </div>
