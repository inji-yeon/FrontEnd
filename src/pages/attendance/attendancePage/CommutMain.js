...
function CommutMain() {
    ...
    const [workedHour, setWorkedHour] = useState('00h 00m 00s');
            ...
            <div className="main2">
                ...
                <div className="today-Info-box">
                    <div className="today-Info">
                        ...
                        <span className="worked">근무시간</span><br/>
